...
//            final String partnerCode = userPartner.getCode();
...
//                    invoiceTypeCode = invoiceDto.getType().getCode();
//                } else if (!invoiceTypeCode.equals(invoiceDto.getType().getCode())) {
...
//                    } else if (!taxPayerNumber.equalsIgnoreCase(partnerCode)) {
//                        return ResponseEntity.ok(DefaultDto.of("4"));
//                    }
//                }
//
