if (NXLOCALE === 'KR') {
    ...
    //<!-- 인증서 관리창 -->
        ...
        NX_WEBUI_MANAGEMENT_TEXT_3 = '인증서 관리',
    ...
    var NX_ISSUE_PUB_TEXT_1 = 'NX_Issue_pubUi 변수가 중복사용되고 있습니다.',
        ...
        NX_ISSUE_PUB_TEXT_31 = '인증서 내보내기 대상 인증서를 선택 후 암호를 입력하세요.',
        //16.01.12추가
    ...
    var NX_WEBUI_LIST_INIT_TEXT_1 = 'Category',
        ...
        NX_WEBUI_SELECT_TEXT_9 = 'Certificate password are case-sensitive',
       	NX_WEBUI_SELECT_TEXT_10 = 'Enter PIN number',
        NX_WEBUI_SELECT_TEXT_11 = 'PIN number of HSM token is case-sensitive.',
        ...
        NX_WEBUI_EX_PFX_FILE_TEXT_8 = 'It has been saved in .pfx (PKCS # 12) format to the path where you selected.',
        //<!-- export-2 -->
    ...
    var NX_ISSUE_PUB_TEXT_1 = 'The variable (NX_Issue_pubUi) is duplicated',
        ...
        NX_ISSUE_PUB_TEXT_35 = 'It may take several minute on user\'s PC environment.',
        NX_ISSUE_PUB_TEXT_36 = 'Do not close your browser until certificate is issued.',
        NX_ISSUE_PUB_TEXT_37 = 'Do you want to cancel to issue certificate?',
        NX_ISSUE_PUB_TEXT_38 = 'Certificate Issuance has been cancelled.',
        NX_ISSUE_PUB_TEXT_39 = 'Please select a storage media.',
