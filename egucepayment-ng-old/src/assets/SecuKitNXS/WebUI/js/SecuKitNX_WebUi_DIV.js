...
KICA_SECUKITNXDIV += '<h1>' + NX_WEBUI_SELECT_TEXT_2 + ' <a href="#" class="btn-setting" onclick="NX_Issue_pubUi.managemnetPageOpen();">' + NX_WEBUI_SELECT_TEXT_1 + '</a> </h1>';
...
if (CERTMGR_F == true)
{
    KICA_SECUKITNXDIV += '<li><a href=\"#certContent_03\" onclick=\"NX_Issue_pubUi.certTabClick(this); NXClientGetVersion(); return false;\">' + NX_WEBUI_MANAGEMENT_TEXT_3 + '</a></li>';   //인증서 관리
}
KICA_SECUKITNXDIV += '</ul>';
KICA_SECUKITNXDIV += '<div class=\"pki-tab-con\">';
