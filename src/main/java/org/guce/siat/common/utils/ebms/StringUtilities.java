...
public final class StringUtilities
{
	...
	/**
	 * Tokenizes a given string according to the specified delimiters. The characters in the delim argument are the
	...
	/**
	 * Tokenizes a given string according to a fixed length. If the last token's length is less than the fixed length
	...
	/**
	 * Concatenates a string array (string tokens) into a string with the specified delimiter string, token's prefix, and
	 * token's suffix.
	 *
	 * @param tokens
	 *           a string array to be concatenated.
	...
	/**
	 * Adds leading zeros to the given string to the specified length. Nothing will be done if the length of the given
	 * string is equal to or greater than the specified length.
	 *
	 * @param s
	 *           the source string.
	 * @param len
	...
	/**
	 * Adds leading spaces to the given string to the specified length. Nothing will be done if the length of the given
	 * string is equal to or greater than the specified length.
	 *
	 * @param s
	 *           the source string.
	...
	/**
	 * Adds specified leading characters to the specified length. Nothing will be done if the length of the given string
	 * is equal to or greater than the specified length.
	 *
	 * @param s
	 *           the source string.
	 * @param c
	...
	/**
	 * Appends zeros to the given string to the specified length. Nothing will be done if the length of the given string
	 * is equal to or greater than the specified length.
	 *
	 * @param s
	 *           the source string.
	...
	/**
	 * Appends spaces to the given string to the specified length. Nothing will be done if the length of the given string
	 * is equal to or greater than the specified length.
	 *
	 * @param s
	 *           the source string.
	...
	/**
	 * Appends specified characters to the given string to the specified length. Nothing will be done if the length of
	 * the given string is equal to or greater than the specified length.
	 *
	 * @param s
	 *           the source string.
	 * @param c
	...
	/**
	 * Returns a string representation of the given throwable object, empty string if it is null. The resulted string
	 * contains a cause trace of the given throwable object.
	 *
	 * @param e
	 *           the throwable object for getting its string representation.
	 ...
	 * @return an array of characters representing the given string or an empty array if the given string is null or
	 *         empty.
	 */
	...
	/**
	 * Trims the given string. If the given string starts with the specified prefix and ends with the specified suffix,
	 * both the prefix and the suffix will be trimmed out.
	 *
	 * @param s
	 *           the string to be trimmed.
	 * @param prefix
	...
	/**
	 * Trims a given string and then verifies its size against the specified size. If the sizes do not match, null will
	 * be returned.
	 *
	 * @param s
	...
	/**
	 * Converts a given string into a string array. The resulted array will contain only one element, which is the
	 ...
	 *           the string to be parsed.
	 * @param def
	 *           the default boolean value when <code>s</code> is null.
	 * @return true if and only if the given string equals, ignoring case, "true".
	 */
	 ...
	 * @param regex
	 * @param group
	 *           the <b>one-based</b> index of the target group. The default group is the zeroth group, which is the
	 *           whole expression
