...
public interface FileTypeDao extends AbstractJpaDao<FileType> {
    ...
    void update(FileType selected, List<FileTypeStep> targetFileTypeStep, List<FileTypeService> targetFileTypeServices);

    List<FileTypeService> findFileTypeServiceByFileType(FileType fileType);

    MinistryFileType findMinistryFileType(FileTypeCode fileTypeCode, String ministryCode);
