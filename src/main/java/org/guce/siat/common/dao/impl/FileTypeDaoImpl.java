...
public class FileTypeDaoImpl extends AbstractJpaDaoImpl<FileType> implements FileTypeDao {
    ...
    public FileType findByCode(final FileTypeCode code) {
        try {
            ...
            TypedQuery<FileType> query = super.entityManager.createQuery(hqlQuery, FileType.class);
    ...
    public List<FileType> findFileTypesByCodes(final FileTypeCode... fileTypeCodes) {
        ...
        try {
            ...
            TypedQuery<FileType> query = super.entityManager.createQuery(hqlQuery.toString(), FileType.class);
            if (!ArrayUtils.isEmpty(fileTypeCodes)) {
    ...
    public MinistryFileType findMinistryFileType(FileTypeCode fileTypeCode, String ministryCode) {
        ...
        TypedQuery<MinistryFileType> query = entityManager.createQuery("SELECT mft FROM MinistryFileType mft WHERE mft.primaryKey.fileType.code = :fileTypeCode AND mft.primaryKey.ministry.code = :ministryCode", MinistryFileType.class);
