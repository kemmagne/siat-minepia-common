...
public interface FileItemService extends AbstractService<FileItem> {
     ...
     * @param listUserAuthorityFileTypes the list user authority file types
     * @param loggedUser the logged user
     * @return the list
     */
    List<FileItem> filterFileItemsByUserAuthorityFileTypes(List<FileItem> productInfoItems,
     ...
     * @param loggedUser the logged user
     * @param informationSystemCode the information system code
     * @param listUserAuthorityFileTypes the list user authority file types
     * @return the list
     */
     ...
     * @return the list
     */
    List<FileItem> findFileItemForRetreiveByFilter(List<Bureau> bureauList, User user,
            InformationSystemCode informationSystemCode, List<UserAuthorityFileType> listUserAuthorityFileTypes,
            RetrieveSearchFilter filter, StepCode stepApAcceptation);

    /**
     * Find file item field value by field code.
     *
     * @param idFile the id file
     * @param idItemField the id item field
     * @return the file item field value
     */
