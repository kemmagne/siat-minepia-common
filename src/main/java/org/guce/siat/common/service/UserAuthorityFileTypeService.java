...
public interface UserAuthorityFileTypeService extends AbstractService<UserAuthorityFileType> {
	 ...
	 *
	 * @param userAuthorityFileTypes the user authority file types
	 * @param user the user
	 */
	 ...
	 *
	 * @param fileType the file type
	 * @param toStep the to step the file
	 * @param file the file
	 * @return the list
	 */
	 ...
	 * @param toStep the to step the file
	 * @param file the file
	 * @param loggedUser the user who is actually dispatching the file
	 * @return the list
	 */
	List<User> findUserByFileTypeAndStepAuthorities(FileType fileType, Step toStep, File file, User loggedUser);
}
