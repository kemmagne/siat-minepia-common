...
public interface FileService extends AbstractService<File>
{
	 ...
	 * @param fileTypeCodes
	 *           the file type codes
	 * @param fileFieldValue1
	 *           the file field value1
	 * @param fileFieldValue2
	 *           the file field value2
	 * @param fileFieldCode1
	 *           the file field code1
	 * @param fileFieldCode2
	 *           the file field code2
	 * @return the file
	 */
