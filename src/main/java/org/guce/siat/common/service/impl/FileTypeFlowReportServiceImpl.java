...
public class FileTypeFlowReportServiceImpl extends AbstractServiceImpl<FileTypeFlowReport> implements FileTypeFlowReportService {
    ...
    @Override
    public FileTypeFlowReport findReportClassNameByFileType(FileType fileType) {
        return fileTypeFlowReportDao.findReportClassNameByFileType(fileType);
    }

    @Override
    public FileTypeFlowReport findReportClassNameByFileFieldName(String fileFieldName) {
        return fileTypeFlowReportDao.findReportClassNameByFileFieldName(fileFieldName);
    }
}
