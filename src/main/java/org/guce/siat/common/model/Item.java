...
public class Item implements Serializable
{
	...
	/**
	 * Législation spéciales: Certains produits sont frappés à l’entrée ou à la sortie de prohibition absolue ou sont
	 * soumis à des restrictions, à des mesures particulières de contrôle, à des formalités spéciales. Ces mesures
	 * particulières sont applicables à la marchandise quelque soit le régime douanier qui lui est assigné.
	 */
	...
	/**
	 * @param goodsItemChapterCode
	 *           the goodsItemChapterCode to set
	 */
	...
	/**
	 * @param goodsItemDescEn
	 *           the goodsItemDescEn to set
	 */
	...
	/**
	 * @param customsStatusCode
	 *           the customsStatusCode to set
	 */
