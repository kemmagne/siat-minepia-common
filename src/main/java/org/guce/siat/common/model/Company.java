...
public class Company extends AbstractModel implements Serializable {
 ...
 /* BEGIN Permis: permit */
     ...
     *
     * @param recipientFirstName the new recipient first name
     */
     ...
     *
     * @param numContribuable the new num contribuable
     */
     ...
     *
     * @param operatorFileList the new operator file list
     */
    ...
    public String getFullAddress() {
        ...
        if (firstAddress != null) {
            returnedString.append(' ').append(firstAddress);
        }
        if (secondAddress != null) {
            returnedString.append(' ').append(secondAddress);
        }
        if (postalCode != null) {
            returnedString.append(' ').append(postalCode);
        }
        if (city != null) {
            returnedString.append(' ' + city);
        }
        if (country != null) {
            returnedString.append(' ').append(country.getCountryName());
        }
     ...
     *
     * @param fullAdress the new full adress
     */
     ...
     *
     * @param commerceApprovalRegistrationNumberFile the
     * commerceApprovalRegistrationNumberFile to set
     */
     ...
     *
     * @param commerceApprovalObtainedDate the commerceApprovalObtainedDate to
     * set
     */
     ...
     *
     * @param commerceApprovalValidityDate the commerceApprovalValidityDate to
     * set
     */
     ...
     *
     * @param commerceApprovalNumberTraderMap the
     * commerceApprovalNumberTraderMap to set
     */
     ...
     *
     * @param businessApprovalType the businessApprovalType to set
     */
     ...
     *
     * @param businessApprovalRegistrationNumber the
     * businessApprovalRegistrationNumber to set
     */
     ...
     *
     * @param businessApprovalDate the businessApprovalDate to set
     */
     ...
     *
     * @param businessApprovalValidityDate the businessApprovalValidityDate to
     * set
     */
    ...
    /**
     * @param permitObtainingDate the permitObtainingDate to set
     */
    ...
    /**
     * @param permitApprovalDate the permitApprovalDate to set
     */
     ...
     *
     * @param tradeRegisterNumber the tradeRegisterNumber to set
     */
    ...
    public boolean equalsWithoutId(Object obj) {
        ...
        if (!Objects.equals(this.recipientFirstName, other.recipientFirstName)) {
            return false;
        }
        if (!Objects.equals(this.companyName, other.companyName)) {
            return false;
        }
        if (!Objects.equals(this.numContribuable, other.numContribuable)) {
            return false;
        }
        ...
        if (!Objects.equals(this.secondAddress, other.secondAddress)) {
            return false;
        }
        ...
        if (!Objects.equals(this.commerceApprovalRegistrationNumberFile, other.commerceApprovalRegistrationNumberFile)) {
            return false;
        }
        if (!Objects.equals(this.commerceApprovalObtainedDate, other.commerceApprovalObtainedDate)) {
            return false;
        }
        if (!Objects.equals(this.commerceApprovalValidityDate, other.commerceApprovalValidityDate)) {
            return false;
        }
        if (!Objects.equals(this.commerceApprovalNumberTraderMap, other.commerceApprovalNumberTraderMap)) {
            return false;
        }
        if (!Objects.equals(this.businessApprovalType, other.businessApprovalType)) {
            return false;
        }
        if (!Objects.equals(this.businessApprovalRegistrationNumber, other.businessApprovalRegistrationNumber)) {
            return false;
        }
        if (!Objects.equals(this.businessApprovalDate, other.businessApprovalDate)) {
            return false;
        }
        if (!Objects.equals(this.businessApprovalValidityDate, other.businessApprovalValidityDate)) {
            return false;
        }
        if (!Objects.equals(this.permitNumber, other.permitNumber)) {
            return false;
        }
        if (!Objects.equals(this.permitObtainingDate, other.permitObtainingDate)) {
            return false;
        }
        if (!Objects.equals(this.permitApprovalDate, other.permitApprovalDate)) {
            return false;
        }
        if (!Objects.equals(this.permitType, other.permitType)) {
            return false;
        }
        if (!Objects.equals(this.tradeRegisterNumber, other.tradeRegisterNumber)) {
            return false;
        }
        if (!Objects.equals(this.cNI, other.cNI)) {
            return false;
        }
        if (this.companyType != other.companyType) {
            return false;
        }
        if (!Objects.equals(this.country, other.country)) {
            return false;
        }
        return Objects.equals(this.operatorFileList, other.operatorFileList);
    }
