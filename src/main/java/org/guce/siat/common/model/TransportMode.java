...
public class TransportMode implements Serializable {
     ...
     * The IPPC CODE
     */
    @Column(name = "IPPC_CODE")
    private String ippcCode;

    /**
     * The code webGuce.
     */
    @Column(name = "CODE_WEBGUCE")
    private String codeWebguce;
     ...
     *
     * @param modeTransportCode the modeTransportCode to set
     */
     ...
     *
     * @param modeTransportName the modeTransportName to set
     */
     ...
     *
     * @param modeTransportNameEn the modeTransportNameEn to set
     */
    ...
    public String getCodeWebguce() {
        return codeWebguce;
    }

    public void setCodeWebguce(String codeWebguce) {
        this.codeWebguce = codeWebguce;
    }
