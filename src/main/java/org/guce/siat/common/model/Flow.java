...
public class Flow extends AbstractModel implements Serializable
{
	 ...
	 *
	 * @param copyRecipientsList
	 *           the copyRecipientsList to set
	 */
	 ...
	 *
	 * @param itemsFlowsList
	 *           the itemsFlowsList to set
	 */
	 ...
	 *
	 * @param fileTypeFlowReportsList
	 *           the new file type flow reports list
	 */
