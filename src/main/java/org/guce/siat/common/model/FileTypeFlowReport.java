...
public class FileTypeFlowReport extends AbstractModel implements Serializable {
     ...
     */
    private static final long serialVersionUID = 2360436256482071256L;
     ...
     *
     * @param reportClassName the new report class name
     */
     ...
     *
     * @param fileFieldName the new file field name
     */
